...
const ENTITY_TYPES = [
  { key: "metric_values", label: "Metric Values", description: "ESG metric data entries" },
  { key: "raw_data_inputs", label: "Raw Data Inputs", description: "Carbon calculator source data" },
  { key: "evidence_files", label: "Evidence Files", description: "Supporting documents" },
  { key: "carbon_calculations", label: "Carbon Calculations", description: "Emissions calculation results" },
  { key: "questionnaires", label: "Questionnaires", description: "ESG survey responses" },
];
    ...
    return (
      <Card>
        <CardContent className="py-5 flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-medium">All data is site-assigned</p>
            <p className="text-xs text-muted-foreground">No legacy (unassigned) records exist.</p>
          </div>
        </CardContent>
      </Card>
    );
    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      {activeSites.length > 0 && (
        <div>
          ...
          <MigrateLegacyDataPanel activeSites={activeSites} />
        </div>
      )}
