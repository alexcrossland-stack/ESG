...
- Final pre-deploy warning cleanup removed the Browserslist data-age warning and client chunk-size warning. The remaining PostCSS `from` warning is documented as a CSS toolchain follow-up; current build output is unaffected.
