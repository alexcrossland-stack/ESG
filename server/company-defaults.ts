...
const CORE_GOVERNANCE_METRICS: SectorMetricRule[] = [
  ...
  { name: "Anti-Bribery Policy in Place", description: "Whether a formal anti-bribery and corruption policy exists", category: "governance", unit: "yes/no", frequency: "annual", dataOwner: "Compliance Manager", metricType: "manual", direction: "compliance_yes_no", displayOrder: 22, helpText: "Select Yes if you have a policy in place, No if not", importance: "standard" },
  { name: "Whistleblowing Policy in Place", description: "Whether a formal whistleblowing policy exists", category: "governance", unit: "yes/no", frequency: "annual", dataOwner: "Compliance Manager", metricType: "manual", direction: "compliance_yes_no", displayOrder: 23, helpText: "Select Yes if you have a policy in place, No if not", importance: "standard" },
  { name: "Cybersecurity Policy in Place", description: "Whether a formal cybersecurity policy exists", category: "governance", unit: "yes/no", frequency: "annual", dataOwner: "IT Manager", metricType: "manual", direction: "compliance_yes_no", displayOrder: 26, helpText: "Select Yes if you have a policy in place, No if not", importance: "standard" },
  { name: "ESG Responsibility Assigned", description: "Whether a named individual is responsible for ESG management", category: "governance", unit: "yes/no", frequency: "annual", dataOwner: "Managing Director", metricType: "manual", direction: "compliance_yes_no", displayOrder: 27, helpText: "Select Yes if ESG responsibility is formally assigned, No if not", importance: "standard" },
  { name: "ESG Targets Set", description: "Whether formal ESG targets have been established", category: "governance", unit: "yes/no", frequency: "annual", dataOwner: "Managing Director", metricType: "manual", direction: "compliance_yes_no", displayOrder: 28, helpText: "Select Yes if formal ESG targets are set, No if not", importance: "standard" },
];
