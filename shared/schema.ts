...
export const metricValues = pgTable("metric_values", {
  ...
  siteNaturalKeyIdx: uniqueIndex("idx_metric_values_metric_period_site_unique")
    .on(table.metricId, table.period, table.siteId)
...
export const metricDefinitionValues = pgTable("metric_definition_values", {
  ...
  orgNaturalKeyIdx: uniqueIndex("idx_metric_definition_values_business_metric_period_org_unique")
    .on(
      table.businessId,
    ...
    .where(sql`${table.siteId} IS NULL`),
  siteNaturalKeyIdx: uniqueIndex("idx_metric_definition_values_business_metric_period_site_unique")
    .on(
      table.businessId,
      table.metricDefinitionId,
      table.reportingPeriodStart,
